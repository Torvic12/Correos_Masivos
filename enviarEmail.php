...
$asunto = "Invitación a RUTA DE LA GESTION EMPRESARIAL";
$cuerpo = '
    <!DOCTYPE html>
    <html lang="es">
    <head>
    <title>Invitación a RUTA DE LA GESTION EMPRESARIAL - $nombre</title>';
$cuerpo .= ' 
<style>
    * {
        margin: 0;
...
$cuerpo .= '
    ...
    $headers .= 'From: Jaime Valencia <aprendiz01@structum-co.com>' . "\r\n";
    $headers .= 'Cc:' . "\r\n";
